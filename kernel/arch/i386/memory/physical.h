 ...
 */
uint32_t Physical_memory_set_page(uintptr_t aPhysicalAddr, Physical_memory_state_e aState);
 ...
 */
uint32_t
Physical_memory_set_region(uintptr_t aPhysicalStartAddr, uintptr_t aPhysicalEndAddr, Physical_memory_state_e aState);
